...
numUsers = 5;                                                              % number of users/number of different applications for allocation
...
%% signal generation
for num_training_files = 1:1
disp(['      number_of_iteration = ' num2str(num_training_files)])
        for fileIdx=1:numfiles
            ...
            for i = 1:numUsers
                while allocPossible(i)==0
                    ...
                    firstTimeSlot = randomParam(40, 32, true, 1, timeSlotsNum-numTSlots+1);     % first time slot index
                    numResourceBlocks = randomParam(16, 0, true, 1, resBlocksNum);               % number of resource blocks (frequency domain)
                    firstRB = randomParam(25, 8, true, 1, resBlocksNum-numResourceBlocks+1);    % first resource block index
...
%             ALLOCATED RESOURCES VISUALISATION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            for SNRind = 1:length(SNR)
                ...
                [detectedRes, energyMtrx] = energyDetection(FFTLength, ...
                    ...
                    timeSlotsNum, ofdmSymbPerTimeSlot, numCPSamples, Pf, noisySignal, variance);
                ...
                if ifWrite2File == 1
                    ...
                    for rB = 1:resBlocksNum
                        ...
                        for tS = 1:timeSlotsNum
                            ...
                            wallNeighbours = neighbourUp1 + neighbourDown1;
                            
%                             try
%                                 neighbourUp2 = decisionTable(rB+2, tS);
%                             catch err
%                                 if err.identifier == "MATLAB:badsubscript"
%                                     neighbourUp2 = 0;
%                                 else
...
%                             end
%                             try
%                                 neighbourDown2 = decisionTable(rB-2, tS);
%                             catch err
%                                 if err.identifier == "MATLAB:badsubscript"
%                                     neighbourDown2 = 0;
%                                 else
...
%                             end
% 
%                             wallNeighbours2 = neighbourUp2 + neighbourDown2;
% 
%                             try
%                                 neighbourUp3 = decisionTable(rB+3, tS);
%                             catch err
%                                 if err.identifier == "MATLAB:badsubscript"
%                                     neighbourUp3 = 0;
%                                 else
...
%                             end
%                             try
%                                 neighbourDown3 = decisionTable(rB-3, tS);
%                             catch err
%                                 if err.identifier == "MATLAB:badsubscript"
%                                     neighbourDown3 = 0;
%                                 else
...
%                             end
% 
%                             wallNeighbours3 = neighbourUp3 + neighbourDown3;
                          
%                             try
%                                 neighbourLeft1 = decisionTable(rB, tS-1);
%                             catch err
%                                 if err.identifier == "MATLAB:badsubscript"
%                                     neighbourLeft1 = 0;
%                                 else
...
%                             end
%                             
%                             LeftNeighbors1 = neighbourLeft1;
%                             try
%                                 neighbourLeft2 = decisionTable(rB, tS-2);
%                             catch err
%                                 if err.identifier == "MATLAB:badsubscript"
%                                     neighbourLeft2 = 0;
%                                 else
