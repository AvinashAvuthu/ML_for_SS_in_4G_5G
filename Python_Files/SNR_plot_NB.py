...
file_results = open("results_NB_ED_numerology1_10UsersUnscatteredOldFeatures_15April2021.txt", "w")
...
for SNR in SNR_tab:
    ...
    y = gnb.fit(X_train, y_train)
    y_pred = gnb.predict(X_test)

    print("Accuracy on training set: {:.3f}%".format(100*gnb.score(X_train, y_train)))
    print("Accuracy on test set: {:.3f}%".format(100*gnb.score(X_test, y_test)))
