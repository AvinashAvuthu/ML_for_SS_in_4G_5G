...
file_results = open("results_kNN_ED_numerology1_10UsersUnscatteredOldFeatures_15April2021.txt", "w")
...
for SNR in SNR_tab:
    ...
    print("Accuracy on training set: {:.3f}%".format(100*knn.score(X_train, y_train)))
    print("Accuracy on test set: {:.3f}%".format(100*knn.score(X_test, y_test)))
