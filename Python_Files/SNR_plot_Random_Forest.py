...
# use with data generated by "prog_A_cyclicRes_data.m" program
...
file_results = open("results_RF_ED_numerology1_10UsersUnscatteredOldFeatures_15April2021.txt", "w")
...
for SNR in SNR_tab:
    ...
    folder_name = "C:/Users/User/Desktop/Habib Resources/Final Year Project/5G Data/Numerology 1/ED_23March_TS80_U10_Unscattered_RescalingRemoved"
    ...
    f_array2 = np.zeros(count_line)
    t_array2 = np.zeros(count_line)
    t_array_f = np.zeros(count_line)
    occ_array2 = np.zeros(count_line)
    dcs_array2 = np.zeros(count_line)
    wall_nghbrs2 = np.zeros(count_line)
    corner_nghbrs2 = np.zeros(count_line)
    ff_data2 = np.zeros(count_line)
